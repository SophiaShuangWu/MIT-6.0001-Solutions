...
# Name: Shuang Wu
# Collaborators: AI built in Trae, Deepseek
# Time spent: 2 days
...
def is_word_guessed(secret_word, letters_guessed):
    ...
    letter_guessed_set = set(letters_guessed)
    secret_word_set = set(secret_word)
    # letter_guessed_set may contain letters that are not in secret_word, i.e. intermediate wrong guesses
    return letter_guessed_set >= secret_word_set
...
def get_available_letters(letters_guessed):
    ...
    for i in string.ascii_lowercase:
        if i not in letters_guessed_set:
            ans += i
    return ans
...
def hangman(secret_word):
    ...
    * After each guess, you should display to the user the 
    ...
    while guesses_remaining > 0:
      ...
      last_letter_guessed = letters_guessed.copy()
      ...
      if str.isalpha(guess) == False:
        if warnings_remaining > 0:
          ...
          continue
      # new guess check
      if guess in last_letter_guessed:
        if warnings_remaining > 0:
          warnings_remaining -= 1
